...
function Env:Window(meta)
	...
	function Env.Tabs:Add(meta)
        ...
        function Env._Class:Telegram(Link)
            local Telegram = Instance.new("Frame")
            local Title_2 = Instance.new("TextLabel")
            local UICorner_1 = Instance.new("UICorner")
            local ImageLabel_1 = Instance.new("ImageLabel")
            local UIGradient_1 = Instance.new("UIGradient")
            ...
            local ClickTelegram = click(Telegram)

            Telegram.Name = "Telegram"
            Telegram.Parent = Section_1
            Telegram.AnchorPoint = Vector2.new(0.5, 0.5)
            Telegram.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            Telegram.BorderColor3 = Color3.fromRGB(0, 0, 0)
            Telegram.BorderSizePixel = 0
            Telegram.Size = UDim2.new(0.97, 0, 0, 60)
            Telegram.ClipsDescendants = true

            Title_2.Name = "Title"
            Title_2.Parent = Telegram
            Title_2.AnchorPoint = Vector2.new(0.5, 0.5)
            Title_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            Title_2.BackgroundTransparency = 1
            Title_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
            Title_2.BorderSizePixel = 0
            Title_2.Position = UDim2.new(0.611293197, 0, 0.408333331, 0)
            Title_2.Size = UDim2.new(0.704753578, 0, 0.150000006, 20)
            Title_2.Font = Enum.Font.GothamBold
            Title_2.Text = "Telegram"
            Title_2.TextColor3 = Color3.fromRGB(255, 255, 255)
            Title_2.TextSize = 16
            Title_2.TextXAlignment = Enum.TextXAlignment.Left

            UICorner_1.Parent = Telegram
            UICorner_1.CornerRadius = UDim.new(0, 5)

            ImageLabel_1.Parent = Telegram
            ImageLabel_1.AnchorPoint = Vector2.new(0.5, 0.5)
            ImageLabel_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ImageLabel_1.BackgroundTransparency = 1
            ImageLabel_1.BorderColor3 = Color3.fromRGB(0, 0, 0)
            ...
            UIGradient_1.Parent = Telegram
            UIGradient_1.Color = ColorSequence.new{
                ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 136, 204)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(5, 199, 255))
            }

            icon_2.Name = "icon"
            icon_2.Parent = Telegram
            ...
            Desc_2.Position = UDim2.new(0.611293197, 0, 0.675000012, 0)
            Desc_2.Size = UDim2.new(0.704753578, 0, -0.0166666675, 20)
            Desc_2.Font = Enum.Font.GothamBold
            Desc_2.Text = Link
            Desc_2.TextColor3 = Color3.fromRGB(255, 255, 255)
            Desc_2.TextSize = 13
            Desc_2.TextTransparency = 0.5
            Desc_2.TextXAlignment = Enum.TextXAlignment.Left

            ClickTelegram.MouseButton1Click:Connect(function()
                pcall(setclipboard, tostring(Link))
                EffectClick(ClickTelegram, Telegram)
                tw({
                    v = icon_2,
                    t = 0.15,
                    s = "Back",
